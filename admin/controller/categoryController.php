...
// Danh mục cha
        ...
        public function insertCategoryParent(){
            if(isset($_POST['btn'])){
                ...
                $result = $this->cate->insertCategoryParent($name, $mota);
        ...
        public function updateCategoryParent(){
            if(isset($_POST['btn'])){
                ...
                $this->cate->updateCategoryParent($name, $mota, $id_sua);
                header('location: main.php?ql=cate_pr');
            }
        }
...
// Danh mục con
        ...
        public function insertCategorySub(){
            if(isset($_POST['btn'])){
                ...
                $result = $this->cate->insertCategorySub($name, $mota, $iddm);
        ...
        public function updateCategorySub(){
            if(isset($_POST['btn'])){
                ...
                $this->cate->updateCategorySub($name, $mota, $iddm, $id_sua);
                $id_sub = isset($_GET['id_sub']) ? $_GET['id_sub'] : '';
                header("location: main.php?ql=cate_sub&id_sub={$id_sub}");
            }
        }

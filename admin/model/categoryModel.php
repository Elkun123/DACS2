...
// Danh mục cha
        ...
        public function insertCategoryParent($name, $mota) {    
            $sql = "INSERT INTO category (T_name_category, T_description) VALUES ('$name', '$mota') ";
            $result = mysqli_query($this->conn, $sql);
            return $result;
        }
        // Sửa thông tin danh mục cha
        public function updateCategoryParent($name, $mota, $id_sua) {
            $sql = "UPDATE category SET T_name_category = '$name', T_description = '$mota' WHERE I_id_category = $id_sua ";
            $result = mysqli_query($this->conn, $sql);
            return $result;
        }
...
// Danh mục con
        ...
        // Thêm danh mục con
        public function insertCategorySub($name, $mota, $iddm) {    
            $sql = "INSERT INTO category (T_name_category, T_description, I_id_parent) VALUES ('$name', '$mota', $iddm) ";
            $result = mysqli_query($this->conn, $sql);
            return $result;
        }
        // Sửa danh mục con
        public function updateCategorySub($name, $mota, $iddm, $id_sua) {
